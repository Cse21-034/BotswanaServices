...
const SubscriptionWidget: React.FC<SubscriptionWidgetProps> = ({
  ...
  const hasPendingUpgrade = subscription?.pendingUpgrade === true;
  const pendingPlanName = subscription?.pendingPlan?.name;
      ...
      <div className="px-6 py-6 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-3 text-center">
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Photos</p>
            <p className="text-2xl font-bold text-gray-900 dark:text-white">
          ...
          <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-3 text-center">
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Promos/mo</p>
            <p className="text-2xl font-bold text-gray-900 dark:text-white">
              {tierInfo.limits.promotions}
            </p>
          </div>
          <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-3 text-center">
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Branches</p>
            <p className="text-2xl font-bold text-gray-900 dark:text-white">
