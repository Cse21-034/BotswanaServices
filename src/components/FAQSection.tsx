...
const faqData: FAQItem[] = [
    ...
    },
    {
        ...
        answer: "You will need to follow up with the vendor by calling or contacting Mzansi Services™ support for assistance via email: support@mzansiservices.co.za"
    },
    {
        question: "If I see a business listing that I think is spam, offensive or illegal, what do I do?",
        answer: "You are welcome to report that listing to us by sending an email to: support@mzansiservices.co.za"
    }
];
