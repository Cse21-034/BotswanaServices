...
const AdvertiseWithUsPage: FC = () => {
  ...
  const valueAddedPackages = [
    ...
    },
    {
      ...
      yearPeriod: "/year",
      discount: "20% DISCOUNT",
      description: "Homepage featured rotating banner with overlay text and CTA",
      features: [
        "Placement: Homepage premium section",
    ...
    },
    {
      ...
      features: [
        "Placement: All pages (floating corner)",
    ...
    },
    {
      ...
      features: [
        "Placement: Homepage & promotions page",
    ...
    },
    {
      ...
      features: [
        "Placement: Business listing detail pages",
  ...
  const namibiaServicesPackages = [
    ...
    },
    {
      ...
      features: [
        ...
        "Social media links",
        "Business hours (public profile)",
        "Location map (public profile)",
        "Services Offered (public profile)",
        ...
        "Enhanced profile & higher ranking",
      ],
      popular: false,
    },
    {
