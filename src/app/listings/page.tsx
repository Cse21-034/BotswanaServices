...
import AdRotatingBanner from "@/components/ads/AdRotatingBanner";
...
const ListingsPage = async () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-950">
      ...
      {/* Advert 4 - Top of category page, landscape, 10-second rotation */}
      ...
      <div className="container py-6 lg:py-10">
        ...
        {!session?.user && (
          <div className="mt-8 lg:mt-12 pt-6 lg:pt-8 border-t border-gray-200 dark:border-gray-800">
            {/* Advert 3 - Above claim listing CTA, landscape, 7-second rotation */}
            ...
            {/* Advert 3 - Below claim listing CTA, landscape, 7-second rotation */}
