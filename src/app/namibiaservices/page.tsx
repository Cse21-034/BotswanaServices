          ...
          <div className="bg-white dark:bg-neutral-800 rounded-2xl p-6 shadow-lg border border-neutral-200 dark:border-neutral-700">
            ...
            <div className="space-y-4">
              {[
                ...
                { action: "Business published", business: "Fresh Farms SA", time: "1 day ago", type: "success" },
                { action: "Review reported", business: "SA Tech Solutions", time: "2 days ago", type: "warning" },
